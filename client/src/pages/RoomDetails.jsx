        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row md:justify-between mt-10'>
                <div className='flex flex-col'>
                    <h1 className='text-3xl md:text-3xl font-playfair'>Rasakan Kemewahan yang Belum Pernah Ada Sebelumnya</h1>
                    <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                        {room.amenities.map((item, index)=>(
                            <div key={index} className='flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-100'>
                                <img src={facilityIcons[item]} alt={item} className='h-5'/>
                ...
                {/* Room Price */}
                <p className='text-2xl font-medium'>IDR {room.pricePerNight}/night</p>    
            </div>
            ...
            <div className='flex flex-col items-start gap-4'>
                <div className='flex gap-4'>
                    ...
                    <div>
                        <p className='text-lg md:text-xl'>Publish oleh {room.hotel.name}</p>
