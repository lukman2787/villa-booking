...
const MyBookings = () => {
    ...
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <Title title='Pemesanan Saya' subTitle='Kelola reservasi hotel Anda yang lalu, saat ini, dan yang akan datang dengan mudah di satu tempat. Rencanakan perjalanan Anda dengan mudah hanya dengan beberapa klik' align="left" />
        ...
        <div className='max-w-6xl mt-8 w-full text-gray-800'>
            ...
            {bookings.map((booking)=>(
                <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b berder-gray-300 py-6 first:border-t'>
                    {/* Hotel Details */}
                    <div className='flex flex-col md:flex-row'>
                        ...
                        <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                            ...
                            <p className='text-base'>Total: IDR {booking.totalPrice}</p>
                        </div>
                    </div>
